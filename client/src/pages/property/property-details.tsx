            ...
            justifyContent="space-between" flexWrap="wrap" alignItems="center">
              <Box>
                ...
                <Stack mt={0.5} direction="row" alignItems="center" gap={0.5}>
                  ...
                  {propertyDetails.addressLine1+' '+propertyDetails.addressLine2+', '+propertyDetails.city+', '+propertyDetails.state+ ', '+propertyDetails.zipcode}
                  </Typography>
                </Stack>
              </Box>
              ...
              >
                  <CustomButton
                      ...
                      handleClick={() => {
                          if (isCurrentUser) {
                              navigate(
                                  `/property/edit/${propertyDetails._id}`,
                              );
                          }
                      }}
                  />
